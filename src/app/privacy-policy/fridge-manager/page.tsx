export default function FridgeManagerPrivacyPolicy() {
  return (
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        body {
          ...
          background: #f8f9fa; color: #212529; line-height: 1.8; padding: 24px 16px 64px;
        }
      ...
      <div className="container">
        <h1>プライバシーポリシー</h1>
        <p className="updated">最終更新日：2026年7月2日</p>
        ...
        <table>
          <thead>
            <tr><th>情報の種類</th><th>取得タイミング</th><th>利用目的</th></tr>
          </thead>
          <tbody>
            <tr>
              <td>カメラ・ギャラリー内の画像（レシート等）</td>
              <td>ユーザーがレシートを撮影、またはギャラリーから画像を選択した時</td>
              <td>食材情報を自動認識し、アプリ内に登録するため（画像はAI解析APIに送信されます）</td>
            </tr>
            <tr>
              <td>アプリ内で登録した食材データ・賞味期限・カテゴリ情報</td>
              <td>ユーザーが情報を入力・登録した時</td>
              <td>食材管理機能の提供のため（端末内のデータベースに保存されます）</td>
            </tr>
            <tr>
              <td>広告識別子（AdID）・端末情報</td>
              <td>アプリ起動時、広告表示・視聴時</td>
              <td>広告配信（バナー広告・リワード広告）のため</td>
            </tr>
            <tr>
              <td>利用回数・機能利用状況（AIレシピ提案の利用回数等）</td>
              <td>アプリ利用時</td>
              <td>1日あたりの利用回数制限機能の提供のため（端末内に保存）</td>
            </tr>
          </tbody>
        </table>
